...
<html lang="en">
  ...
  <body>
    <nav>
      <div class="nav__logo">Stark Airlines</div>
      <ul class="nav__links">
     
        <li class="link"><a href="booking.jsp">Search flight</a></li>
      </ul>
    ...
    <section class="section__container travellers__container">
      <h2 class="section__header">Most visited places of the month</h2>
      <div class="travellers__grid">
        <div class="travellers__card">
          <img src="assets/traveller-1.jpg" alt="Dubai" />
          <div class="travellers__card__content">
            <img src="dubai-image.jpg" alt="Dubai" />
            <h4></h4>
            <p>Dubai</p>
          </div>
        </div>
        <div class="travellers__card">
          <img src="assets/traveller-2.jpg" alt="Paris" />
          <div class="travellers__card__content">
            <img src="paris-image.jpg" alt="Paris" />
            <h4></h4>
            <p>Paris</p>
          </div>
        </div>
        <div class="travellers__card">
          <img src="madrid-city.jpg" alt="Madrid" />
          <div class="travellers__card__content">
            <img src="madrid-image-1.jpg" alt="client" />
            <h4></h4>
            <p>Madrid</p>
          </div>
        </div>
        <div class="travellers__card">
          <img src="rio-city.jpg" alt="Rio de janeiro" />
          <div class="travellers__card__content">
            <img src="rio-image.jpg" alt="Rio" />
            <h4></h4>
            <p>Rio De janeiro</p>
          </div>
        </div>
    ...
    <footer class="footer">
      <div class="section__container footer__container">
        ...
        <div class="footer__col">
          ...
          <a href="AboutStarkAirlines.jsp">About</a><br>
          <a href="booking.jsp">Search flight</a>
      ...
      <div class="section__container footer__bar">
        <p>Copyright © 2024 Weslie. All rights reserved.</p>
        <div class="socials">
